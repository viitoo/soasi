class EmpleadosController < ApplicationController
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:nombre1, :nombre2, :apellido1, :apellido2, :tipo_identificacion, :numero_identificacion, :genero, :fecha_nacimiento, :lugar_nacimiento, :telefono, :email, :edo_civil)
    end
end
