...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { email: @empresa.email, nombre: @empresa.nombre, ruc: @empresa.ruc, telefono: @empresa.telefono, ubicacion: @empresa.ubicacion } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { email: @empresa.email, nombre: @empresa.nombre, ruc: @empresa.ruc, telefono: @empresa.telefono, ubicacion: @empresa.ubicacion } }
